...
public class CommandImplementation implements Command {
    ...
    @Override
    public Commands getCommandName() {return commandName;}

    @Override
    public String getCommandValue() {return commandValue;}

    @Override
    public boolean isUnknown() {return (commandName == Commands.UNKNOWN);}

    @Override
    public boolean hasCommandValue () {return (commandValue != null);}
}
