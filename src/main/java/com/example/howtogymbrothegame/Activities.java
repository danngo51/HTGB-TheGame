...
public class Activities {
    ...
    private void eatingUnhealthy(){
        ...
        String unHealthyTwo = "Hjertekar-sygdomme, som kommer af forhøjet kolesterol, forhøjet blodtryk og overvægt. Chancen for diabetes type 2 bliver forøget ved at være overvægtig, som kan føre til hyppige infektioner. \n \n";
    ...
    private void eatingHealthy() {
        String healthy = "Du har truffet det rigtige valg. Det er vigtigt at spise varieret, hvilket betyder en kost der har højt indhold af frugt, fibre, protein og grøntsager og lavt indhold af mættet fedt, salt, rødt kød og simple sukkerarter. \n \n";
        String healthyTwo = "Det vigtige ved at træffe sunde valg er at undgå at udvikle sygdomme, som kan komme ved en kost, der indeholder for meget af det, som har en negativ påvirkning. \n \n";
